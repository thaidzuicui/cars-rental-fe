  ...
  return (
    <>
      <motion.div
        ...
        initial={{ scale: 0 }}
        className={`fixed inset-x-2 top-28 lg:top-[12.75rem] flex flex-col rounded-lg bg-white p-4 dark:bg-gray850 xs:inset-x-auto sm:flex-row 
            ${!isPopular && "xs:-mr-14 sm:mr-0"} ${
          location.pathname === "/search" && "xs:ml-3 xs:mr-1 sm:mr-4 lg:ml-6"
        }
        max-w-[30rem] lg:max-w-[65.9rem] z-50
        `}
      >
